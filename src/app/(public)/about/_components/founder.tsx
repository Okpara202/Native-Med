...
const aboutFounder = ({ text }: { text: string }) => {
  return <p className="text-subtle2 text-lg leading-[150%] mt-5">{text}</p>;
};

const founderLaurel = ({ text }: { text: string }) => {
  return (
    <p className="text-lg leading-[120%] tracking-[-2%] text-subtle2 -mt-2">
      {text}
    </p>
  );
};
...
function Founder() {
  return (
    <section className="px-15 radialBgGradient pt-20 pb-44">
      <div className="flex justify-between items-start gap-8">
        ...
        <aside className="basis-2/5">
          ...
          <div className="mt-2.5 space-y-2.5 text-center">
            <h2 className="text-2xl leading-[130%] -tracking-[2%] text-blackOthers font-semibold">
              Dr Clinton Ohaa
            </h2>
            <h4 className="font-semibold text-lg leading-[120%] tracking-[-2%] text-blackOthers">
              MBBS, MRCS, MRCGP, MBA
            </h4>
            {founderLaurel({
            ...
            <p className="text-lg leading-[120%] tracking-[-2%] mt-2.5 font-semibold text-Secondary100">
              FOUNDER
            </p>
          </div>
        </aside>
