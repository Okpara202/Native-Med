...
function MissionStatement() {
  return (
    <section>
      <div className="bg-black-others pt-12 md:pt-20 text-center pb-32 md:pb-60 space-y-2.5 px-4 md:px-0">
        <h2 className="font-semibold text-2xl sm:text-3xl md:text-4xl leading-[130%] tracking-[-2%] text-primary-white mt-3 capitalize">
          Mission Statement
        </h2>
        <p className="leading-[130%] md:leading-[120%] font-medium text-base sm:text-xl md:text-2xl text-gray-1 mx-auto w-[90%] md:w-[60%]">
